      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-6 animate-fade-in">
          ...
          <div className="flex gap-2 self-stretch md:self-auto shrink-0">
            ...
            {isLeader && isDraft && (
              <button
                ...
                disabled={approving}
                className="flex-1 md:flex-none flex items-center justify-center gap-2 py-2.5 px-6 bg-primary text-on-primary hover:bg-primary/95 text-sm font-bold rounded-xl transition-all shadow-md disabled:opacity-50"
              >
                {approving ? (
                  <>
            ...
            {!isDraft && (
              ...
              >
                {triggeringCI ? (
                  ...
                  <>
                    <span className="material-symbols-outlined text-sm font-bold text-primary">play_circle</span>
        ...
        {!isDraft && (
          <section className="bg-surface-container-lowest border border-outline-variant/60 rounded-2xl p-4.5 shadow-sm grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Task Link */}
            <div className="flex items-center gap-3.5 p-3 rounded-xl bg-primary-fixed/20 border border-primary-fixed/40">
              <span className="material-symbols-outlined text-2xl text-primary font-bold">assignment</span>
              <div>
                ...
                <button
                  ...
                  className="text-xs font-bold text-primary hover:underline mt-0.5 text-left"
                >
            ...
            <div className="flex items-center gap-3.5 p-3 rounded-xl bg-secondary-fixed/20 border border-secondary-fixed/40">
              <span className="material-symbols-outlined text-2xl text-primary font-bold">settings_ethernet</span>
              <div>
              ...
              <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-2xl p-6 shadow-sm space-y-6">
                ...
                <form onSubmit={handleAddComment} className="flex gap-2 border-t border-outline-variant/50 pt-4">
                  <input
                    ...
                    className="flex-1 px-3.5 py-2 text-xs bg-surface-container-low border border-outline-variant rounded-xl focus:outline-none focus:border-primary text-on-surface"
                  />
                  <button
                    type="submit"
                    className="py-2 px-4 bg-primary text-on-primary hover:bg-primary/95 text-xs font-bold rounded-xl transition-all shadow"
                  >
                    Post Comment
                  </button>
                </form>
                    ...
                    {task.checklist.map((item) => (
                      ...
                      >
                        <input
                          ...
                          className="mt-0.5 accent-primary h-4 w-4 shrink-0 rounded border-outline-variant text-primary focus:ring-primary cursor-pointer"
                        />
