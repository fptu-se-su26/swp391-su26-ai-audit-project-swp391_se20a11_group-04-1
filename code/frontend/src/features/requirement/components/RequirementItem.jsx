      ...
      <div className="col-span-8 sm:col-span-5 md:col-span-4 lg:col-span-4 flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          <span className="flex items-center gap-2">
            ...
            {aiGenerated && <span className="inline-flex items-center gap-1 bg-[#EEEDFE] text-[#6366F1] px-1.5 py-0.5 rounded text-[10px] font-bold shrink-0" title="Generated by AI"><span className="material-symbols-outlined text-[12px]">auto_awesome</span> AI</span>}
          </span>
