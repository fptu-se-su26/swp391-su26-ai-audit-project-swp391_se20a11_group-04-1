  ...
  return (
    <div className="sticky bottom-0 left-0 right-0 w-full bg-surface border-t border-outline-variant px-margin_desktop py-stack_md flex justify-end items-center gap-stack_md shadow-[0_-4px_12px_rgba(0,0,0,0.05)] z-20">
      ...
      <button 
        ...
        onClick={onSave}
        disabled={loading}
        className="px-6 py-2 h-11 rounded-lg font-body-md text-body-md font-medium text-white bg-[#1E707D] hover:bg-[#165964] transition-colors shadow-sm flex items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
      >
        {loading ? (
