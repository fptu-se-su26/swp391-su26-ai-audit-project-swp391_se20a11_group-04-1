...
const AIGenerationProgressModal = ({ isOpen, requirementCount = 1, onClose }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Simulate progress bar width filling up over time
      ...
      return () => {
        window.removeEventListener('AI_PROGRESS', handleProgress);
            ...
            <div className="flex items-start justify-between px-[24px] pt-[24px] pb-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[#6B7280] mt-0.5">AI is analyzing your requirements</p>
                </div>
              </div>
              {onClose && (
                <button 
