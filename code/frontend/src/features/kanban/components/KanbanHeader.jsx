const KanbanHeader = ({ isCompactBoard, onToggleCompact, onCreateTask, onGenerateAITasks }) => {
  return (
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            ...
            className="h-[36px] px-4 bg-primary text-white rounded-lg font-semibold flex items-center space-x-2 hover:bg-primary-hover transition-colors text-sm"
          >
