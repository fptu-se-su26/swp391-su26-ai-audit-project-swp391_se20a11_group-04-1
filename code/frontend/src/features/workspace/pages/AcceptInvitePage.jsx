  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden select-none">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[20%] left-[20%] w-[500px] h-[500px] rounded-full bg-[#D7EEF1] opacity-[0.06] blur-[130px]"></div>
      ...
      <div className="relative z-10 max-w-md w-full bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-8 shadow-2xl text-center space-y-6 animate-scale-up">
        {status === 'processing' && (
          <div className="space-y-5 py-6">
            <div className="w-16 h-16 border-4 border-[#1E707D] border-t-transparent rounded-full animate-spin mx-auto"></div>
        ...
        {status === 'success' && (
          <div className="space-y-5 py-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-on-surface-variant leading-relaxed">
                Chào mừng bạn đến với dự án. Đang chuyển hướng bạn về Dashboard sau <strong className="text-[#1E707D]">{countdown}s</strong>...
              </p>
            </div>
            <button
              onClick={() => navigate('/dashboard')}
              className="w-full py-3 bg-[#1E707D] text-white font-bold rounded-2xl hover:bg-[#D7EEF1] hover:text-[#1E707D] transition-all shadow-md text-sm mt-4"
            >
              Chuyển hướng ngay
            </button>
          </div>
          ...
          <div className="space-y-5 py-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 py-3 bg-[#1E707D] text-white font-bold rounded-2xl hover:bg-[#D7EEF1] hover:text-[#1E707D] transition-all shadow-md text-sm"
              >
                Thử lại
              </button>
            </div>
