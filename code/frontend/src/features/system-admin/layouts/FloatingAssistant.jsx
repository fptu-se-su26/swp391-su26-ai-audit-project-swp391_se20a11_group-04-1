...
const FloatingAssistant = () => {
  return (
    <button className="fixed bottom-margin_desktop right-margin_desktop w-14 h-14 bg-[#1E707D] text-white rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-transform z-50 group">
