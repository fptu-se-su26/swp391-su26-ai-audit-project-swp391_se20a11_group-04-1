...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    @Async
    public void sendSecurityAlertEmail(String toEmail, String username, int failedAttempts, long lockTimeMinutes, String deviceInfo, String location, String unlockLink) {
        ...
        try {
            ...
            helper.setText(getSecurityAlertHtmlContent(username, failedAttempts, lockTimeMinutes, deviceInfo, location, unlockLink), true);
    ...
    public void sendEmergencyAttackAlertEmail(String toEmail, String username, 
        ...
        try {
            ...
            helper.setText(getEmergencyAttackAlertHtmlContent(username, ipDetailsMap, unlockTokensMap, blockTokensMap), true);
    ...
    private String getSecurityAlertHtmlContent(String username, int failedAttempts, long lockTimeMinutes, String deviceInfo, String location, String unlockLink) {
        return "<!DOCTYPE html>" +
                "<html>" +
                "<head>" +
                "    <meta charset='utf-8'>" +
                ...
                "            <p>Hệ thống bảo mật đã phát hiện <strong>" + failedAttempts + " lần nhập sai mật khẩu liên tiếp</strong> từ thiết bị của bạn. Để đảm bảo an toàn, chúng tôi đã tạm thời khóa tính năng đăng nhập của tài khoản trên thiết bị này trong <strong>" + lockTimeMinutes + " phút</strong>.</p>" +
                "            " +
                "            <div class='alert-box'>" +
                ...
                "                <a href='" + unlockLink + "' class='btn-whitelist'>Xác nhận đây là tôi & Mở khóa thiết bị</a>" +
                "            </div>" +
                "            " +
    ...
    private String getEmergencyAttackAlertHtmlContent(String username, 
        ...
        for (String ip : ipDetailsMap.keySet()) {
            ...
            String unlockLink = "http://192.168.1.3:8080/api/v1/auth/unlock?token=" + unlockToken;
            String blockLink = "http://192.168.1.3:8080/api/v1/auth/block-ip?token=" + blockToken;
            
            devicesHtml.append("            <div class='device-card'>")
                       .append("                <p class='device-info'>• <strong>Thiết bị:</strong> ").append(details).append("</p>")
                       .append("                <p class='device-info'>• <strong>Địa chỉ IP:</strong> ").append(ip).append("</p>")
                       .append("                <div style='margin-top: 15px; text-align: center;'>")
                       .append("                    <a href='").append(unlockLink).append("' class='btn-action btn-green'>Đây là tôi (Whitelist)</a>")
                       .append("                    <a href='").append(blockLink).append("' class='btn-action btn-red'>Thiết bị lạ (Chặn vĩnh viễn)</a>")
                       .append("                </div>")
                       .append("            </div>");
        }
